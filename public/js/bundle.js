...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>\"></div>");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoianVtYW5peW96b3YiLCJhIjoiY2tiNTA1cjRiMGgzOTJ4cGR1MG5sYnh1bSJ9.F9hpIhYZuGrGuKPfZj5WXQ';
...
var stripe = Stripe('pk_test_s9qCsKErGhjYmsCGDKZ46PI700BJXwADi8');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/bookings/checkout-session/".concat(tourID));
